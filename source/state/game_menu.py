...
class Game_Menu:
    ...
    def set_backgroud(self,screen):
        ...
        if self.state == "Custom":
            ...
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.width),C.WHITE,(375+2,296+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.width),C.WHITE,(375-2,296-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.width),C.WHITE,(375+2,296-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.width),C.WHITE,(375-2,296+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.width),C.BLACK,(375,296),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.height),C.WHITE,(375+2,366+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.height),C.WHITE,(375-2,366-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.height),C.WHITE,(375+2,366-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.height),C.WHITE,(375-2,366+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.height),C.BLACK,(375,366),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.mines),C.WHITE,(375+2,436+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.mines),C.WHITE,(375-2,436-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.mines),C.WHITE,(375+2,436-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.mines),C.WHITE,(375-2,436+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,str(self.mines),C.BLACK,(375,436),True)            
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width :',C.WHITE,(200+2,296+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width :',C.WHITE,(200-2,296-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width :',C.WHITE,(200+2,296-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width :',C.WHITE,(200-2,296+2),True)        
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width :',C.BLACK,(200,296),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height :',C.WHITE,(200+2,366+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height :',C.WHITE,(200-2,366-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height :',C.WHITE,(200+2,366-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height :',C.WHITE,(200-2,366+2),True)        
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height :',C.BLACK,(200,366),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Mines :',C.WHITE,(200+2,436+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Mines :',C.WHITE,(200-2,436-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Mines :',C.WHITE,(200+2,436-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Mines :',C.WHITE,(200-2,436+2),True)
            ...
            if self.start_check:
                ...
                temp.fill(C.GRAY)
                self.blit_title(temp,text,setup.mine_sweeper_font_16,2)
                screen.blit(temp,self.start.topleft)
        else:
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width : '+str(self.width),C.WHITE,(276+2,296+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width : '+str(self.width),C.WHITE,(276-2,296-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width : '+str(self.width),C.WHITE,(276+2,296-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width : '+str(self.width),C.WHITE,(276-2,296+2),True)        
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Width : '+str(self.width),C.BLACK,(276,296),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height : '+str(self.height),C.WHITE,(276+2,366+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height : '+str(self.height),C.WHITE,(276-2,366-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height : '+str(self.height),C.WHITE,(276+2,366-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height : '+str(self.height),C.WHITE,(276-2,366+2),True)        
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Height : '+str(self.height),C.BLACK,(276,366),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Mines : '+str(self.mines),C.WHITE,(276+2,436+2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Mines : '+str(self.mines),C.WHITE,(276-2,436-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Mines : '+str(self.mines),C.WHITE,(276+2,436-2),True)
            tool.blit_text(screen,setup.mine_sweeper_font_24,'Mines : '+str(self.mines),C.WHITE,(276-2,436+2),True)
